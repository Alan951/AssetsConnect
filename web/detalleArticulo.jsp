<%-- 
    ...
    Description: Formulario con validaciones correctas para modificar un artículo existente.
--%>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <div class="col-md-4" id="newArticulo">
            <form class="form-signin" id="formArticulo" role="formArticulo">
                ...
                <div class="container botones">
                    <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2 eliminar">
                        <button class="btn btn-lg btn-danger btn-block" type="submit" id="eliminar">Eliminar</button>
                    </div>
                    <div class="col-xs-7 col-sm-4 col-md-3 col-lg-3 modificar">
